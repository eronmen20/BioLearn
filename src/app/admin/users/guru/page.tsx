  ...
  const columns: Column<User>[] = [
    {
      ...
      render: (u) => (
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-[#f59e0b]/10 flex items-center justify-center text-[#f59e0b] text-sm font-semibold">
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        description="Kelola akun guru yang terdaftar"
      />
      ...
      {total === 0 && !loading ? (
        <div className="text-center py-16 bg-white rounded-xl border border-dashed">
          ...
          <h3 className="text-lg font-semibold text-gray-700">Belum Ada Guru</h3>
          <p className="text-sm text-gray-500 mt-1">Akun guru akan muncul di sini setelah role diubah dari Siswa ke Guru.</p>
        </div>
      ) : (
        <DataTable
          columns={columns}
          ...
          emptyMessage="Tidak ditemukan guru yang cocok"
        />
      )}
