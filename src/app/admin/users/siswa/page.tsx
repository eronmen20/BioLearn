...
import { Users, GraduationCap, Trash2, Edit3, ShieldCheck, ShieldX, CheckCircle, XCircle } from 'lucide-react';
...
export default function SiswaPage() {
  ...
  const fetchUsers = useCallback(async () => {
    setLoading(true);
    try {
      const params = new URLSearchParams({ role: 'user', page: String(page), limit: '50' });
  ...
  const columns: Column<User>[] = [
    {
      ...
      render: (u) => (
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-[#6c5ce7]/10 flex items-center justify-center text-[#6c5ce7] text-sm font-semibold">
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        description="Kelola akun siswa yang terdaftar"
      />
